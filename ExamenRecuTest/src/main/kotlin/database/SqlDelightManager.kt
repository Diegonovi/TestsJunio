...
import org.attackontitans.database.AppDatabase
...
class SqlDelightManager(
    private val databaseUrl: String = "jdbc:sqlite:troupe.db",
    private val databaseInitData: Boolean = false,
    ...
    private fun removeAllData() {
        ...
        databaseQueries.transaction {
            databaseQueries.removeAllTroupes()
        }
    }
}